...
# Set up page config with a custom logo and blue background
st.set_page_config(page_title="Chess Legends", page_icon="https://i.postimg.cc/vBZcwTSH/Chat-GPT-Image-Jul-2-2025-10-04-14-AM.png")

# Custom CSS for blue background and sidebar styling
st.markdown("""
    <style>
        .stApp {
...
# About Us Page
    ...
    with col1:
        ...
        **Dhairya Mehta**  
        ...
        📧 mehtadhairya11@gmail.com | 📧 28stu521@lexingtonma.org | 📱 857-832-1547
        """)
